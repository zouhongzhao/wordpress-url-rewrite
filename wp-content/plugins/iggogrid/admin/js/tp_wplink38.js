...
(function($){
	...
	wpLink = {
		...
		htmlUpdate : function() {
			...
			// IggoGrid: Don't insert a title attribute
			// if ( attrs.title )
			...
			// IggoGrid: Insert the value of the Title field as the Link Text
			if ( attrs.title ) {
				html += attrs.title;
			}
	...
	// Change "Title" to "Link Text", for changed IggoGrid link insertion behavior
