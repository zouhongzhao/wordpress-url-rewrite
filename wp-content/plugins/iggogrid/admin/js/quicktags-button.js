...
/* global iggogrid_editor_button, QTags, tb_show */
...
jQuery( document ).ready( function( $ ) {
	 ...
	 * @since 1.0.0
	 */
	window.iggogrid_open_shortcode_thickbox = function() {
		...
		tb_show( iggogrid_editor_button.thickbox_title, iggogrid_editor_button.thickbox_url + '&TB_iframe=true&height=' + ( H - 85 ) + '&width=' + ( W - 80 ), false );
	};
	 ...
	 */
	QTags.addButton(
		'iggogrid_quicktags_button',				// ID
		iggogrid_editor_button.caption,			// button caption
		window.iggogrid_open_shortcode_thickbox,	// click callback
		false,										// unused
		false,										// access key
		iggogrid_editor_button.title,				// button title
